...
@if($viewType == 'default')
    ...
    <div class="message-card" data-id="{{ $id }}">
        <p>{!! ($message == null && $attachment != null && @$attachment[2] != 'file') ? $attachment[1] : nl2br($message) !!}
            ...
            <a href="{{route('attachments.download',['fileName'=>$attachment[0]]) }}" style="color: #595959;" class="file-download">
    ...
    <div>
        <div class="message-card">
            <div class="image-file chat-image" style="width: 250px; height: 150px;background-image: url('{{ asset('storage/'.'chat'.'/'.$attachment[0]) }}')">
            </div>
        </div>
    </div>
    @endif
